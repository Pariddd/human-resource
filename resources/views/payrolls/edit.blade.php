            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('payrolls.index') }}">Presence</a></li>
                ...
                <form action="{{ route('payrolls.update', $payroll->id) }}" method="POST">
                    ...
                    <div class="mb-2">
                        ...
                        <select name="employee_id" id="employee_id" class="form-control @error('employee_id') is-invalid @enderror">
                            ...
                            <option value="{{ $employee->id }}" @if(old('employee_id', $payroll->employee_id) == $employee->id) selected @endif>
                              {{ $employee->fullname }} 
                            </option>
                            @endforeach
                        </select>
